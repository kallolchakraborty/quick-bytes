...
6. **Production engineering trumps model choice** — Prompt engineering, RAG, caching, batching, and evaluation framework often have more impact than picking between GPT-4 and Claude-3 for a given task.`
    ...
    },
    {
      ...
      level: 'L5/L6',
      description: 'Design patterns, migrations, monorepo, microservices, and ADRs.',
      guides: [],
    },
    {
      id: 'reliability-devops',
      title: 'Reliability & DevOps',
      level: 'L5/L6',
      description: 'CI/CD pipelines, observability, incident response, and cost optimization.',
      guides: [],
    },
    {
      id: 'leadership-process',
      title: 'Leadership & Process',
      level: 'L6',
      description: 'RFCs, code review culture, OKRs, mentoring, and cross-team strategy.',
      guides: [],
    },
    {
      id: 'staff-plus',
      ...
      level: 'L7+',
      description: 'Influence without authority, technical vision, and org-wide impact.',
      guides: [],
    },
    {
      id: 'interview-prep',
      ...
      level: 'All',
      description: 'System design interviews, behavioral questions, and coding patterns.',
      guides: [],
    },
  ],
};
