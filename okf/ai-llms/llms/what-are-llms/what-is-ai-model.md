...
description: What is LLMs, Types & Examples - What is an AI Model?
tags: [what-is-ai-model,what-are-llms,llms]
timestamp: 2026-08-26T23:11:16.576Z
section: what-is-ai-model
guide: what-are-llms
phase: llms
icon: psychology
---
...
An **AI model** is a mathematical system trained on data to perform a task that normally requires human intelligence — recognizing patterns, making predictions, or generating content. It learns a *function* that maps inputs to outputs, parameterized by weights learned during training.
